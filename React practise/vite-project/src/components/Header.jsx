...
function Header() {
  ...
  return (
    <div className="w-[120rem] h-[2.625rem] flex justify-center items-center">
      ...
      <div className="w-[82.5rem] h-min flex justify-between items-center">
        
        {/* Left Side */}
        <div className="flex items-center gap-[0.5rem]">
          <svg xmlns="http://www.w3.org/2000/svg" width="0.9375rem" height="1.125rem" viewBox="0 0 17 20" fill="none">
          ...
          <p className="text-[#666] text-[0.75rem] not-italic font-normal leading-[0.975rem]">Store Location: Lincoln- 344, Illinois, Chicago, USA</p>
        </div>

        {/* Right Side */}
        <div className="flex items-start gap-[.25rem] text-[#666] text-[0.75rem] not-italic font-normal leading-[0.975rem]">
