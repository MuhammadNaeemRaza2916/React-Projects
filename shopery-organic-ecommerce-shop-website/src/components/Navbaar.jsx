...
function Navbaar() {
    return (
        <div className='w-[120rem] py-[1rem] px-[18.75rem] bg-[#333] flex justify-center items-center mt-[1rem]'>
            <div className='flex justify-between w-[82.5rem]'>
                <div className="menuLeft flex justify-center">
                    <ul className='flex gap-[2rem] justify-center'>
                        <li className='text-white'>Home</li>
                        <li className='text-[#999]'>Shop</li>
                        <li className='text-[#999]'>Pages</li>
                        <li className='text-[#999]'>Blog</li>
                        <li className='text-[#999]'>About Us</li>
                        <li className='text-[#999]'>Contact Us</li>
                    </ul>
                </div>
                <div className="menuRight flex gap-[.5rem]">
                    <svg className='w-[1.75rem] h-[1.75rem]' xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                    ...
                    <div className='text-white text-[0.875rem] not-italic font-medium leading-[1.3125rem] pt-[.2rem]'>(219) 555-0114</div>
                </div>
